...
<div class="container">
<!-- CLIENTS: "OUR HAPPY CLIENTS" replaced with "SPONSORS"; originally at about_us.php
		Edit CLIENTS at ABOUT US Section. This will still show up regardless if About us section is activated or not. -->
	<?php
		//if(is_active_sidebar( 'sidebar-aboutus' )):
			echo '<div class="our-clients">';
				echo '<h2><span class="section-footer-title">'.__('SPONSORS','zerif-lite').'</span></h2>';
			echo '</div>';
